...
borderRadius:"7px",background:"#272727",color:"#fff",textAlign:"center",fontSize:"24px",marginLeft:"auto",marginRight:"auto",marginTop:"20px"});this.d.g=a;this.m.appendChild(a)};c.D=function(){var a=this.d;a.control=document.createElement("div");this.m.appendChild(a.control);n(a.control,{position:"absolute",right:"100px",bottom:"100px",width:"60px",height:"60px"});for(var a=["top","right","bottom","left"],b=0;b<a.length;b++)this.F(a[b])};c.F=function(a){var b=this.d,d=document.createElement("div");
n(d,{width:"0",height:"0",position:"absolute",borderStyle:"solid",borderColor:"transparent",borderWidth:"30px"});var f={left:"right",top:"bottom"},c,e;for(e in f)f.hasOwnProperty(e)&&(e==a?c=f[e]:f[e]==a&&(c=e));n(d,c,"100%");n(d,"border"+u(c)+"Color","#333");n(d,"border"+u(c)+"Width","80px");n(d,"border"+u(a)+"Width","0");b["ctrl"+a]=d;b.control.appendChild(d);q(d,"click",function(){this.dir=a.charAt(0);this.move()},this)};c.e=function(a){return this.areas[a]};c.Y=function(){var a=[];this.map(function(b){b.c||
